...
module.exports = function (container, opts) {
  ...
  overview.innerHTML = 'One of the great things about node.js is the ecosystem of composable, reusable modules. But with so many, it can be hard to find what you want, or discover something new! <br><br> To try and help, we trained a machine learning model called <a href="https://code.google.com/archive/p/word2vec/">word2vec</a> on the npm package corpus, treating each module as a "sentence", and its dependencies as "words". <br><br> If you type a package name, you will see packages that tend to be used alongside it. <br><br> The code for this service is on <a href="http://github.com/andrewosh/npm-recommender">github</a>, and is itself powered by cool npm modules, like <a href="https://npmjs.org/package/word2vec">word2vec</a> and <a href="https://npmjs.org/package/cradle">cradle</a>. You can  query it as an API at http://npmrec.com/api/similar/<package>. <br><br>Made by <a href="https://github.com/andrewosh">@andrewosh</a> and <a href="https://github.com/freeman-lab">@freeman-lab</a>. We hope you enjoy it!'
